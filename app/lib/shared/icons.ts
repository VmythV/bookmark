 ...
 * Returned as HTML strings so they can be dropped into innerHTML or templates.
 * Sized via the `.icon` class (1em) — set font-size / text-* on the parent.
 */
...
/** Returns an `<svg>` HTML string for the given icon, classed `icon`. */
